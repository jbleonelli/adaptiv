    ...
    <>
      <header className={cn(
        ...
        <nav className="container-site flex items-center justify-between h-16 md:h-[72px]">
          <Link href="/" className="text-[#111827]" aria-label="Adaptiv AI Technologies">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 pt-16 bg-white md:hidden overflow-y-auto">
          <div className="container-site py-8 flex flex-col gap-1 border-t border-[rgba(0,0,0,0.06)]">
            ...
            <div className="pt-6">
              <Link href="/login" className="block w-full text-center px-6 py-3.5 rounded-full bg-[#FF00B2] text-white font-semibold">
                Login
              </Link>
            </div>
          </div>
